...
public class TenantManagerConfigurationUnitTest {
    ...
    public void testCreateTenantConfigProvisioning() {
        ...
        configurations.add(Configuration.of().path("/config/tenants/{tenantName}/communication/default-email-spec.yml").build());
        configurations.add(Configuration.of().path("/config/tenants/{tenantName}/communication/emails/uaa/activation/en.yml").build());
        configurations.add(Configuration.of().path("/config/tenants/{tenantName}/communication/emails/uaa/creation/en.yml").build());
        configurations.add(Configuration.of().path("/config/tenants/{tenantName}/communication/emails/uaa/passwordReset/en.yml").build());


        verify(tenantConfigRepository).createConfigsFullPath(eq(TENANT_KEY), eq(configurations));
